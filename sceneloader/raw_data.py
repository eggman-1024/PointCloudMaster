...
##########################################
# @Author: rtzhang
# @Date: 2025-03-15 14:53:46
# @LastEditors: rtzhang
# @LastEditTime: 2025-03-15 15:28:14
# @Description: 用于检查carla原始点云数据的DatasetLoader
##########################################
...
class raw_data(DatasetLoader_Base):
    def __init__(self, scene_id, json_data):
        super(raw_data, self).__init__(scene_id, json_data)
    ...
    def load_frame(self, frame_id):
        ...
        # 打印data中id字段的数据类型
        print(f"data['id']的类型为: {type(data['id'][0])}")
        other_data = {}
